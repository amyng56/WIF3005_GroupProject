                ...
                {this.state.askForUsername === true ?
                    ...
                    <div>
                        <div className="btn-down"
                            ...
                            <IconButton style={{color: "#f44336"}} onClick={() => {
                                if (window.confirm("Do you want to end this call?")) this.handleEndCall()
                            }}>
                                <CallEndIcon/>
                            </IconButton>
                        ...
                        <Modal show={this.state.showModal} onHide={this.closeChat} style={{zIndex: "999999"}}>
                            ...
                            <Modal.Footer className="div-send-msg">
                                <Input placeholder="Message" value={this.state.message}
                                       onChange={e => this.handleMessage(e)} onKeyPress={(e) => {
                        ...
                        <div className="container">
                            ...
                            <ScrollToBottom className="subtitles-menu display">
                                <div className="text-pattern" hidden={this.state.transcript == null}>
                                    <div>
                                        <p><b>{this.state.transcript}</b></p>
                                    </div>
                                </div>
                            </ScrollToBottom>
